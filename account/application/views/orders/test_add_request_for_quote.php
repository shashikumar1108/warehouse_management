          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Add Request For Quotation</span></span></li>
              </ol>
            </nav>
          </div>
...
<script type="text/javascript">
  ...
  function addLabel(){
    $('#tableID').append('<tr id="rows-add-product-label"><td style=width:"50%";font-weight:bold;><label>Product Name</label></td><td style=width:"25%";font-weight:bold;><label>Quantity</label></td><td style=width:"25%";font-weight:bold;><label class="for-action">Action</label></td></tr>');
  }
