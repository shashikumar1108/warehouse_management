          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Track Shipment</span></li>
              </ol>
            </nav>
          </div>
          <div class="row">
                    ...
                    <tbody>
                      <?php /* $i=1; foreach($quotation_list as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?= base_url()?>orders/add_track_shipment/<?php echo $row['quotation_id']?>">New Shipment</a>
                            </td>                                                                
                        </tr>
                      <?php $i++;} */ ?>
                    </tbody>
  ...
  <script>
    ...
    function initializeTable(){
      datatable = $('#table-listing').DataTable({
          ...
          "lengthChange": true,
          "ajax": {
              "url": "<?=base_url()?>orders/getTrackShipmentTableList",
              "type": "post",
          },
          // "aLengthMenu": [
          //     [5, 10, 15],
