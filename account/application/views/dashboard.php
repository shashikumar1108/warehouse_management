                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center;">
                        <h5>Total Sub Catgeories One</h5>                        
                      </div>
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $total_subcategories_one; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center;">
                        <h5>Total Sub Catgeories Two</h5>                        
                      </div>
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $total_subcategories_two; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center;">
                        <h5>Total Payment Pending</h5>                        
                      </div>
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $payment['pending']; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div> 
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center;">
                        <h5>Total Payment Paid</h5>                        
                      </div>
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?=$payment['paid']?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
