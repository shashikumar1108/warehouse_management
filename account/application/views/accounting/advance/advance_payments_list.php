          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Advance Payments</span></li>
              </ol>
            </nav>
          </div>
          <div class="row">
                    ...
                    <tbody>
                      <?php /* $i=1; foreach($quotation_list as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?= base_url()?>accounting/add_advance_payment/<?php echo $row['quotation_id']?>">New Advance Payment</a>
                            </td>                                                                
                        </tr>
                      <?php $i++;} */ ?>
                    </tbody>
  ...
  <script>
    ...
    function initializeTable(){
      datatable = $('#table-listing').DataTable({
          ...
          "lengthChange": true,
          "ajax": {
              "url": "<?=base_url()?>accounting/getAdvancePaymentTableList",
              "type": "post",
          },
          // "aLengthMenu": [
          //     [5, 10, 15],
