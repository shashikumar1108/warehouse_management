          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url('accounting/paid_invoice')?>">Paid Invoice</a></li>
                <li class="breadcrumb-item active" aria-current="page"><span>Paid Invoice Details</span></li>
              </ol>
            </nav>
          </div>
                  ...
                  <form method="post" action="<?php echo base_url('accounting/update_pending_invoice'); ?>">
                    ...
                    <div class="form-group col-md-12 col-lg-12" style="padding-left: 0px !important;padding-right: 0px !important;">
                      <table class="table table-bordered" id="view-product-table" style="width: 100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" class="form-control" value="<?php echo $row['breakage_qty']?>" disabled>
                          </td>
                          <td>
                            <input type="text" class="form-control" value="<?php echo $row['reduced_wh_amount']?>" disabled>
                          </td>
                          <td>
                            <input type="text" class="form-control" value="<?php echo $row['total_wh_amount']?>" id="total_wholesale_price<?php echo $i;?>" disabled>
                          </td>
                        </tr>
                        <?php $i++; } ?>
                      </table>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-2 col-lg-2">
                        ...
                        <input type="date" class="form-control" name="payment_date" value="<?php echo $invoice['payment_date']?>" readonly>
                      </div>
