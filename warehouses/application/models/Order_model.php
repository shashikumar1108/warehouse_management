...
class Order_model extends CI_Model {
   ...
   public function getWarehouseSuppliers($warehouse_id = null)
   {
      ...
      public function edit_quotation_details($quotation_id, $warehouse_id = 0){
         $where = array(
            'quotation_id' => $quotation_id,
         );
         if( $warehouse_id != 0 ){ $where['warehouse_id'] = $warehouse_id; }
         return $this->db->select('*')->from('quotation')->where($where)->get()->row_array();
      }
      ...
      public function get_current_quotation_product_ids($quotation_id){
   	...
   	public function delete_quotation_details($temp_data,$where = array()){
   		$this->db->where($where)->update('quotation',$temp_data);
      ...
      public function get_order_quotation_table_list($payload = array(), $proposal_status = 4, $warehouse_id = 0){
      ...
      public function get_order_quotation_details($proposal_status, $warehouse_id = 0){
      ...
      public function get_single_order_quotation_details($quotation_id,$proposal_status,$warehouse_id = 0, $vendor_quote_id = 0){
         ...
         $this->db->where(array('q.quotation_id' => $quotation_id,'vq.proposal_status' => $proposal_status,'q.warehouse_id'=>$warehouse_id));
      ...
      public function get_order_price_details($quotation_id,$proposal_status,$warehouse_id = 0,$vendor_quote_id = 0){
