          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Paid Invoice</span></li>
              </ol>
            </nav>
          </div>
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <table id="table-listing" class="table" style="width:100%;">
                    ...
                    <tbody>
                      <?php /* $i=1; foreach($invoice_list as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?= base_url()?>accounting/paid_invoice_details/<?php echo $row['quotation_id']?>">View Details</a>
                            </td>                                                                
                        </tr>
                      <?php $i++;} */ ?>
                    </tbody>
  ...
  <script>
    ...
    function initializeTable(){
      datatable = $('#table-listing').DataTable({
          ...
          "lengthChange": true,
          "ajax": {
              "url": "<?=base_url()?>accounting/getPaidInvoiceTableList",
              "type": "post",
          },
          // "aLengthMenu": [
          //     [5, 10, 15],
