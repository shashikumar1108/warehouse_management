          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Stock Position</span></li>
              </ol>
            </nav>
          </div>
                    ...
                    <table class="table table-bordered" id="view-product-table" style="width: 100%">
                      ...
                      <?php $i=1; 
                        if( count($stock_list) == 0 ){
                          ?>
                          <tr>
                            <td colspan="9" class="text-center font-weight-bold"><h5>No records found</h5></td>
                          </tr>
                          <?php
                        }
                        ...
                        <form method="post" action="<?php echo base_url('stock/create_stock_position')?>" >
                          ...
                          <td>
                            <select class="form-control js-example-basic-single w-100%" style="width:100%" name="rack_id" required="">
                              ...
                              <?php $rack = $this->db->select('id,rack_number,description')->from('racks')->where('warehouse_id',$row['warehouse_id'])->get()->result_array(); ?>
                              <?php 
                                  foreach($rack as $r){ ?>
