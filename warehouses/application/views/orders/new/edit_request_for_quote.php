          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Edit Quotations</span></li>
              </ol>
            </nav>
          </div>
                  ...
                  <form method="post" action="<?php echo base_url('orders/update_quotation'); ?>">
                    ...
                    <div class="row">  
                      ...
                      <div class="form-group col-md-3 col-lg-3">
                        ...
                        <select disabled class="form-control js-example-basic-single w-100%" style="width:100%" name="warehouse_id">
                          <option value="">-- Select Warehouse --</option>
                          <?php $warehouse = $this->db->select('id,name')->from('warehouse')->where('delete_status',0)->get()->result_array(); ?>
                          <?php 
                              foreach($warehouse as $w){ ?>
                                  <option <?php if($w['id'] == $warehouse_id ){ echo "selected"; }  ?> value="<?php echo $w['id'] ?>" <?php if($quotation['warehouse_id'] == $w['id']) {echo "selected";}?>><?php echo $w['name'] ?></option>
                          <?php } ?>
                        </select>
                      </div>
