                    ...
                    <?php $i = 0;
                        foreach($warehouses as $w){ $i++; ?>
                            <tr>
                                ...
                                <label class="badge badge-primary"><a style="color:white" href="<?php echo base_url(); ?>warehouse/WarehouseOrders?id=<?php echo $w['id'] ?>">Orders</a></label>
                        ...
                        <td>      
                          ...
                          <a href="" data-toggle="modal" data-target="#edit_warehouse_<?php echo $w['id']; ?>" data-whatever="@getbootstrap">Edit</a>
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="<?php echo base_url(); ?>WarehouseOrders?id=<?php echo $w['id'] ?>">Orders</a>                          
                          </div>
                        </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="name" class="col-form-label">GST Number:</label>
                              <input type="text" class="form-control" name="gst" id="gst" value="<?php echo $w['gst']; ?>" required>
                            </div>
                            <div class="form-group">
                              <label for="name" class="col-form-label">Pan Number:</label>
