...
<body>
        ...
        <div class="content-wrapper">
          <div class="card">
            ...
            ?>
              ...
              <span>
                  <button style="display:none;" type="button" class="btn btn-warning" style="float:right" data-toggle="modal" data-target="#add_batch" data-whatever="@getbootstrap">Add Batch</button>
                </span> <br><br><br>
              <div class="row">
                    ...
                    <?php $i = 0;                    
                        ...
                        ?>
                            <tr>
                                ...
                                <label class="badge badge-danger"><a href="<?php echo base_url(); ?>suppliers/deleteBatch?id=<?php echo $b['id'] ?>">Delete</a></label>
                                ...
                                <label class="badge badge-warning"><a href="<?php echo base_url(); ?>suppliers/editBatchView?id=<?php echo $b['id'] ?>">Edit</a></label>
                                <!-- <label class="badge badge-success" data-toggle="modal" data-target="#assign_batch_<?php echo $b['id'] ?>" data-whatever="@getbootstrap">Assign</label> -->
 ...
 -->
            <div class="modal fade" id="assign_batch_<?php echo $b['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-md" style="" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Assign Batch to Warehouse</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                        <form method="post" action="<?php echo base_url('suppliers/assignBatchToWarehouse'); ?>">
                            <div class="row">
                     ...
                     <!-- <label for="name" class="col-form-label">Select Warehouse:</label> -->
                        <?php foreach($warehouses as $w){ ?>                          
                            <input tabindex="<?php echo $w['id'] ?>-<?php echo $b['id'] ?>" type="radio" id="square-radio-<?php echo $w['id'] ?>-<?php echo $b['id'] ?>" name="warehouse_id" value="<?php echo $w['id'] ?>">
                            <label style="margin-right:15px;" for="square-radio-<?php echo $w['id'] ?>-<?php echo $b['id'] ?>"><?php echo $w['name'] ?></label>                          
                        <?php } ?>
                        <!-- </div> --> 
                        ...
                        <div class="form-group col-md-12 col-lg-12">
                          ...
                          <input type="number" class="form-control" name="quantity" id="quantity" min="1" max="<?php echo $b['quantity'] ?>" value="1" required>
                        </div>                                
                                                                                                             
                        
                        <div class="modal-footer">
                          <button type="submit" class="btn btn-success">Assign Batch</button>
                          <button type="button" class="btn btn-light" data-dismiss="modal">Close</button>
                        </div>
                        </div>
                        </form>            
                  ...
                  <div class="modal fade" id="add_batch" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" style="width:80%; left:8vw; top:-5vh" role="document">
                      <div class="modal-content" style="border:5px solid dodgerblue">
                        ...
                        <div class="modal-body">
                        <form method="post" action="<?php echo base_url('suppliers/addBatch'); ?>">
                            <div class="row">
                                <input type="hidden" name="product_id" value="<?php echo $product_id ?>" />
