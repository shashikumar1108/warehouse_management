        ...
        <div class="content-wrapper">
          <div class="card">
            ...
            || $this->session->flashdata('status') == 'fail') {
              ...
              <span class="card-title">Brand Sectors</span>
              <span>
                    ...
                    <?php $i = 0;                    
                        foreach($data as $d){ $i++;    ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                <td>
                                <label class="badge badge-danger"><a href="<?php echo base_url(); ?>brand/BrandSector/delete?id=<?php echo $d['id'] ?>">Delete</a></label>
                  ...
                  <div class="modal fade" id="edit_<?php echo $d['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-4" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url('brand/BrandSector/edit'); ?>">
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-4" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form method="post" action="<?php echo base_url('brand/BrandSector/add'); ?>">
                            <div class="form-group">
                              <label for="name" class="col-form-label">Name:</label>
