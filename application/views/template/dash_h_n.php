    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas sidebar-dark" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="orders">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('orders/request_for_quote'); ?>">Request For Quote</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('orders/approve_rfq'); ?>">Approve RFQ</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('vendor/new_quotation_list'); ?>">Vendor Quote</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('orders/new_confirm_quotation_list'); ?>">Confirm Quote</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('vendor/confirmed_delivery_order'); ?>">Vendor Delivery Note</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#stocks" aria-expanded="false" aria-controls="tables">
              <i class="menu-icon icon-grid"></i>
            ...
            <div class="collapse" id="stocks">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('stock/stock_position'); ?>">Stock Position</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('stock/stock_availability'); ?>">Stock Availbility</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('stock/transfer_of_stocks'); ?>">Transfer of Stocks</a>
                </li>
              </ul>
            </div>
          </li>
