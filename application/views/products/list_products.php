...
<!--                             <div class="form-group col-md-6 col-lg-6">
                              <label for="name" class="col-form-label">Quantity:</label><br>
                              <select class="form-control js-example-basic-single w-100%" style="width:100%" name="edit_quantity" id="edit_quantity" >
                            ...
                            <label for="name" class="col-form-label">Category:</label><br>
                              <select class="form-control js-example-basic-single w-100%" style="width:100%" name="category" id="edit_category<?php echo $i; ?>" required onchange="updateSubCategoryoneList(this.value, <?php echo $i; ?>)">
                            ...
                            <label for="name" class="col-form-label">Sub Category One:</label><br>
                              <select class="form-control js-example-basic-single w-100%" style="width:100%" name="sub_category_one" id="edit_sub_category_one_id<?php echo $i ?>" required onchange="updateSubCategorytwoList(this.value, <?php echo $i; ?>)">
                                <option value="">-- Select Sub Category One --</option>
                                <?php $ones = $this->db->select('*')->from('sub_categories_one')->where('category_id',$p['category'])->get()->result_array(); ?>
                                <?php 
                                    foreach($ones as $o){ ?>
                            ...
                            <label for="name" class="col-form-label">Sub Category Two:</label><br>
                              <select class="form-control js-example-basic-single w-100%" style="width:100%" name="sub_category_two" id="edit_sub_category_two_id<?php echo $i ?>" required>
                                <option value="">-- Select Sub Category Two --</option>
                                <?php $twos = $this->db->select('*')->from('sub_categories_two')->where(array('category_id' => $p['category'],'sub_category_one_id' => $p['sub_category_one']))->get()->result_array(); ?>
                                <?php 
                                    foreach($twos as $t){ ?>
                    ...
                    <div class="modal-dialog modal-lg" style="width:70%; left:9vw" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url('products/addProduct'); ?>">
                            ...
                            <!-- <div class="form-group col-md-6 col-lg-6">
                              <label for="name" class="col-form-label">Quantity:</label><br>
                              <select class="form-control js-example-basic-single w-100%" style="width:100%" name="quantity" id="quantity">
                                <option value="">-- Select Quantity --</option>
                              </select>
                            </div> -->
                            ...
                            <div class="form-group col-md-6 col-lg-6">
                            <label for="name" class="col-form-label">Category:</label><br>
                              <select class="form-control js-example-basic-single w-100% add_category" style="width:100%" name="category" id="category" required onchange="fetchSubCategoryOne(this.value);">
                                <option value="">-- Select Category --</option>
                                <?php $category = $this->db->select('*')->from('category')->get()->result_array(); ?>
                                <?php 
                                    foreach($category as $c){ ?>
                            ...
                            <div class="form-group col-md-6 col-lg-6">
                            <label for="name" class="col-form-label">Sub Category One:</label><br>
                              <select class="form-control js-example-basic-single w-100% add_sub_category_one" style="width:100%" name="sub_category_one" id="sub_category_one" required onchange="fetchSubCategorytwo(this.value);">
                                <option value="">-- Select Sub Category One --</option>
                              </select>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-lg-6">
                            <label for="name" class="col-form-label">Sub Category Two:</label><br>
                              <select class="form-control js-example-basic-single w-100% add_sub_category_two" style="width:100%" name="sub_category_two" id="sub_category_two" required>
                                <option value="">-- Select Sub Category Two --</option>
                              </select>
                            </div>
...
<script type="text/javascript">
    ...
    $.ajax({
      ...
      success : function(result){
          ...
          $(res.data).each(function(){
            ...
            output2 = output2 + '<option value="">Select Sub Category Two</option>';
            $(".add_sub_category_two").html(output2);
      }
    });
  }
  ...
  function updateSubCategoryoneList(cat_id, modal_no){
    ...
    $.ajax({
      ...
      success : function(result){
          ...
          output2 = output2 + '<option value="">Select Sub Category Two</option>';
          $("#edit_sub_category_two_id"+modal_no).html(output2);
  ...
  function updateSubCategorytwoList(sub_category_one_id, modal_no){
    ...
    let output = '';
    var category_id = $('#edit_category'+modal_no).val();
    $.ajax({
      url: '<?=base_url("category/getSubCategorytwo")?>',
      type: 'GET',
      data: {'category_id': category_id,'sub_category_one_id' : sub_category_one_id },
