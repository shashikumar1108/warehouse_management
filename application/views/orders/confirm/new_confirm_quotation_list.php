          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                <li class="breadcrumb-item"><a href="<?php echo base_url('orders/new_confirm_quotation_list')?>">Confirm Quote</a></li>
                    ...
                    <tbody>
                      <?php $i=1; foreach($quotation_list as $row) {
                        ...
                        <tr>
                          <td><?php echo $i; ?></td>
                          <td>
                            <a href="<?= base_url()?>orders/view_quotation_proposals/<?php echo $row['quotation_id']?>">View Quotes</a>
                          </td>
                          <td><?php echo $row['ref_number']; ?></td>                                
                          <td><?php echo $warehouse['name']; ?></td>
                          <td><?php echo $row['quotations']; ?></td>                                                   
                        </tr>
                      <?php $i++;} ?>
                    </tbody>
                  </table>
