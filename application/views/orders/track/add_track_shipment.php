          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                <li class="breadcrumb-item"><a href="<?php echo base_url('orders/track_shipment')?>">Track Shipment</a></li>
                <li class="breadcrumb-item active" aria-current="page"><span>Add Track Shipment</span></li>
              </ol>
            </nav>
          </div>
                  ...
                  <form method="post" action="<?php echo base_url('orders/create_track_shipment'); ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-2 col-lg-2">
                        ...
                        <input type="text" class="form-control" name="lorry_number"  autocomplete="off">
                      </div>

                      <div class="form-group col-md-3 col-lg-3">
                        <label class="col-form-label">Lorry Details:</label>
                        <textarea class="form-control" rows="4" cols="50"  name="lorry_details" required=""></textarea>
                      </div>
