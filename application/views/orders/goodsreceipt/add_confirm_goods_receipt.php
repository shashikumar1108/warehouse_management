                    ...
                    <div class="form-group col-md-12 col-lg-12" style="padding-left: 0px !important;padding-right: 0px !important;">
                      <table class="table table-bordered" id="view-product-table" style="width: 100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" class="form-control" name="breakage_qty[]" id="breakageQty<?php echo $i;?>" required onkeyup="calTotalAmt(<?php echo $i; ?>)" autocomplete="off">
                          </td>
                          <td>
  ...
  <script type="text/javascript">
    ...
    function calTotalAmt(row){
      ...
      if(breakageQty > quantity){
        ...
        // console.log("breakageQty : ",breakageQty);
        if(breakageQty > 0){
        ...
        }else if( isNaN(breakageQty) === true || breakageQty === 0 ){
          console.log('Reset value');
          total_wholesale_price = wholesale_price * quantity;
          $('#reduced_wh_amount'+row).val('0');
          $('#total_wh_amount'+row).val(total_wholesale_price);
          ...
          var grand_wholesale_price = 0;
          $('.net_total_wh_amount').each(function(){
            // console.log(this.value);            
             if($(this).val() > 0){
              grand_wholesale_price = parseInt(grand_wholesale_price) + parseInt($(this).val());
             }
          });
          grand_wholesale_price = grand_wholesale_price + transport_cost;
          // console.log("grand_wholesale_price : ",grand_wholesale_price);
          $('#grand_wholesale_price').val(grand_wholesale_price);
