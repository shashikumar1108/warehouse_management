          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                <li class="breadcrumb-item"><a href="<?php echo base_url('orders/new_confirm_quotation_list')?>">Confirm Goods Receipt Note</a></li>
                <li class="breadcrumb-item active" aria-current="page"><span>New Goods Receipt</span></li>
              </ol>
            </nav>
          </div>
          <div class="row">
                    ...
                    <tbody>
                      <?php $i=1; foreach($quotation_list as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?= base_url()?>orders/add_confirm_goods_receipt/<?php echo $row['quotation_id'].'/'.$row['vendor_quote_id']?>">New Receipt</a>
                            </td>                                                                
                        </tr>
                      <?php $i++;} ?>
                    </tbody>
