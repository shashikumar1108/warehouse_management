                    ...
                    <tbody>
                      <?php $i=1; foreach($quotation_list as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?= base_url()?>orders/edit_request_for_quote/<?php echo $row['quotation_id']?>">Edit</a>
                              <label class="badge badge-danger"><a href="<?php echo base_url(); ?>orders/delete_quotation?id=<?php echo $row['quotation_id'] ?>" onclick="return confirm('Are you sure to delete?')">Delete</a></label>
