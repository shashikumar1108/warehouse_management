          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                <li class="breadcrumb-item active" aria-current="page"><a href='<?php echo base_url('vendor/new_quotation_list')?>'>Vendor Delivery</a></li>
                <li class="breadcrumb-item"><span>Confirmed Order List</span></li>
              </ol>
            </nav>
          </div>
          <div class="row">
                    ...
                    <tbody>
                      <?php $i=1; foreach($order_quotation_list as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?= base_url()?>vendor/add_delivery_note/<?=$row['quotation_id']?>/<?=$row['vendor_quote_id']?>" class="btn btn-warning">New Note</a>
                            </td>                                                                
                        </tr>
                      <?php $i++;} ?>
                    </tbody>
