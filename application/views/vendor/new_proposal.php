                  ...
                  <form method="post" action="<?php echo base_url('vendor/add_quotation_proposal'); ?>">
                    <div class="row">
                      ...
                      <div class="form-group col-md-3 col-lg-3">
                        ...
                        <select class="form-control js-example-basic-single w-100%" style="width:100%" id="supplier_id" name="supplier_id" required >
                          <?php $supplier = $this->db->select('id,name')->from('suppliers')->where('delete_status',0)->get()->result_array(); ?>
                    ...
                    <div class="groove row">
                      ...
                      <div class="form-group col-md-12 col-lg-12"></div>
