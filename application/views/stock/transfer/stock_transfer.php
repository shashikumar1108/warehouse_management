          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Stock Transfer</span></li>
              </ol>
            </nav>
          </div>
                    ...
                    <table class="table table-bordered" id="view-product-table" style="width: 100%">
                      ...
                      <form method="post" action="<?php echo base_url('stock/create_stock_transfer')?>" >
                        ...
                        <td>
                          ...
                          <?php 
                            $warehouse = $this->db->select('id,name')
                              ->from('warehouse')
                              ->where(array('id!='=>$row['warehouse_id'],'delete_status'=>0))
                              ->get()->result_array(); ?>
                          <?php 
