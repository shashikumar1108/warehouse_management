                    ...
                    <tbody>
                      <?php $i=1; foreach($quotation_list as $row) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['supplier_name'].'<br>'.$row['phone'].'<br>'.$row['email']; ?></td>
                            <td>
                              <a href="<?= base_url()?>accounting/add_advance_payment/<?php echo $row['quotation_id'].'/'.$row['vendor_quote_id']?>">New Advance Payment</a>
                            </td>                                                                
                        </tr>
                      <?php $i++;} ?>
                    </tbody>
