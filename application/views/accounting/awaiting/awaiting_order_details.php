          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                <li class="breadcrumb-item"><a href="<?php echo base_url('accounting/awaiting_order_confirmation')?>">Awaiting Order Confirmation</a></li>
                <li class="breadcrumb-item active" aria-current="page"><span>Payment Details</span></li>
              </ol>
            </nav>
          </div>
                  ...
                  <form method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-2 col-lg-2">
                        ...
                        <input type="text" class="form-control" name="paid_amount" value="<?php echo $invoice['paid_amount']?>" readonly="">
                      </div>

                      <div class="form-group col-md-2 col-lg-2">
                        <label class="col-form-label">Pending Amount:</label>
                        <input type="text" class="form-control" name="pending_amount" value="<?php echo $invoice['pending_amount']?>" readonly="">
                      </div>
