        ...
        <div class="content-wrapper">
          <div class="card">
            ...
            ?>
              ...
              <span class="card-title">Warehouse Products</span>
              <span>
                    ...
                    <?php $i = 0;                    
                        ...
                        ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                <td>
                                <label class="badge badge-danger"><a href="<?php echo base_url(); ?>warehouse/deleteProduct?id=<?php echo $p['id'] ?>&&warehouse_id=<?php echo $warehouse_id?>">Delete</a></label>
                                ...
                                <label class="badge badge-success"><a href="<?php //echo base_url(); ?>products/batches?id=<?php //echo $p['id'] ?>">Batches</a></label>
                                 -->
                                 <label class="badge badge-success"><a href="<?php echo base_url(); ?>warehouse/batches?id=<?php echo $p['id'] ?>">Batches</a></label>
                  ...
                  <div class="modal fade" id="add_product" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-md" style="width:70%; left:9vw;" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url('warehouse/addProduct'); ?>">
