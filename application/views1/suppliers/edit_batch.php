            ...
            ?>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                        ...
                        <form method="post" action="<?php echo base_url('suppliers/editBatch'); ?>">
                            <div class="row">
                            ...
                            <div class="form-group col-md-4 col-lg-4">
                             ...
                             <div class="form-group col-md-4 col-lg-4">
                              ...
                              <input type="number" class="form-control" name="quantity" id="quantity" min="0" value="<?php echo $batch[0]['quantity'] ?>" required>
                            </div>
