                    ...
                    <?php $i = 0;                    
                        foreach($data as $d){ $i++;    ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                <td>
                                <label class="badge badge-danger"><a href="<?php echo base_url(); ?>Initilization/units/delete?id=<?php echo $d['id'] ?>">Delete</a></label>
                  ...
                  <div class="modal fade" id="edit_<?php echo $d['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-4" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url('Initilization/units/edit'); ?>">
                            ...
                            <div class="form-group">
                              <label for="name" class="col-form-label">Symbol:</label>
                              <input type="text" class="form-control" name="symbol" id="symbol" value="<?php echo $d['symbol']; ?>"" required>
                            </div>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-4" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form method="post" action="<?php echo base_url('Initilization/units/add'); ?>">
                            <div class="form-group">
                              <label for="name" class="col-form-label">Name:</label>
