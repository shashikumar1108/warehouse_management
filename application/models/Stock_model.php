...
class Stock_model extends CI_Model {
   ...
   public function get_stock_position_price_details($quotation_status,$stock_status,){
      ...
      $this->db->where(array('q.quotation_status' => $quotation_status,'vqad.stock_status' => $stock_status,'vq.proposal_status'=>6));
   ...
   public function get_stock_availability_price_details($quotation_status,$stock_status){
      ...
      $this->db->where(array('q.quotation_status' => $quotation_status,'vqad.stock_status' => $stock_status));
      return $this->db->get()->result_array();
   }
