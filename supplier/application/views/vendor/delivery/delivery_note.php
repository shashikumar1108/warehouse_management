          ...
          <div class="template-demo">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>Vendor Delivery Note</span></li>
              </ol>
            </nav>
          </div>
          <div class="row">
                    ...
                    <tbody>
                      <?php /* $i=1; foreach($order_quotation_list as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="<?= base_url()?>vendor/add_delivery_note/<?php echo $row['quotation_id']?>" class="btn btn-warning">New Note</a>
                            </td>                                                                
                        </tr>
                      <?php $i++;} */ ?>
                    </tbody>
  ...
  <script>
    ...
    function initializeTable(){
        ...
        datatable = $('#table-listing').DataTable({
            ...
            "lengthChange": true,
            "ajax": {
                "url": "<?=base_url()?>vendor/getConfirmedDeliveryNoteTableList",
                "type": "post",
            },
            // "aLengthMenu": [
            //     [5, 10, 15],
