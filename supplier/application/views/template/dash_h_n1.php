        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="orders">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('vendor/new_quotation_list'); ?>">Quotations</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('vendor/confirmed_delivery_order'); ?>">Delivery Notes</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="accounting">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url('accounting/payments'); ?>">Payments</a>
                </li> 
              </ul>
            </div>
          </li>
