                  ...
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $counters['quotations']; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $counters['delivery_notes']; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                      <p class="text-muted"><?php echo $counters['shipments']; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $amount['total']; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>

                <div class="col-12 col-sm-12 col-md-12"><br></div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $amount['paid']; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="card" style="border:2px solid dodgerblue; border-radius:3%">
                    <div class=""> <br>
                      ...
                      <div class="justify-content-between pb-2" style="text-align:center; font-weight:bold">                        
                        <p class="text-muted"><?php echo $amount['balance']; ?></p>
                      </div>                     
                    </div>
                  </div>
                </div>
