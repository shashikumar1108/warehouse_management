            ...
            <div class="col-12 table-responsive">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" onsubmit="return validateForm();" action="<?php echo base_url('orders/create_track_shipment'); ?>">
                    ...
                    <div class="form-group col-md-12 col-lg-12" style="padding-left: 0px !important;padding-right: 0px !important;">
                      <table class="table table-bordered" id="view-product-table" style="width: 100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <?php $category = $this->db->select('*')->from('sub_categories_one')->get()->result_array(); ?>
                            <?php foreach($category as $c){ 
                              if($row['sub_category_one_id'] == $c['id']) { $category_name =  $c['name']; }
                            }?>
                            <input type="text" class="form-control" value="<?php echo $category_name; ?>" disabled>
                          </td>
                          <td>
                            <?php $category = $this->db->select('*')->from('sub_categories_two')->get()->result_array(); ?>
                            <?php foreach($category as $c){ 
                              if($row['sub_category_two_id'] == $c['id']) { $category_name =  $c['name']; }
                            }?>
                            <input type="text" class="form-control" value="<?php echo $category_name; ?>" disabled>
                          </td>
                          <td>
                          ...
                          <td>
                            <input type="text" class="form-control" value="<?php echo $row['total_qty']?>" id="quantity<?php echo $i; ?>" disabled>
                          </td>
                          <td>
                            <input type="text" class="form-control" value="<?php echo $row['wholesale_price']?>" id="wholesale_price<?php echo $i;?>" disabled>
                          </td>
                          <td>
                            <input type="text" class="form-control" value="<?php echo $row['w_total_amount']?>" id="w_total_amount<?php echo $i;?>" disabled>
                          </td>                          
                          <td>
                    ...
                    <div class="row">
                      <div class="form-group col-md-2 col-lg-2">
                        ...
                        <input type="text" class="form-control" name="lorry_number" required="" autocomplete="off" value="<?=$vendor_quotation['lorry_number']?>">
                      </div>
